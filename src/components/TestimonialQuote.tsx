...
export function TestimonialQuote({
  ...
  return (
    <section className="mx-auto max-w-6xl px-5 py-20 md:px-8 md:py-24" aria-label="Testimonial">
      <div className="relative overflow-hidden border border-line/70 bg-white/70 px-5 py-8 sm:px-8 sm:py-10 md:px-14 md:py-14">
        <div
          className="absolute left-0 top-0 h-full w-1.5 bg-gradient-to-b from-brand via-brand-bright to-accent"
          aria-hidden
        />
        <span
          className="pointer-events-none absolute -right-2 -top-6 font-display text-[5rem] leading-none text-brand/[0.07] sm:text-[7rem] md:text-[9rem]"
          aria-hidden
        >
          “
        </span>
        ...
        <blockquote className="relative mt-5">
          <p className="font-display text-lg font-medium leading-relaxed text-ink sm:text-xl md:text-2xl md:leading-snug">
            {quote.text}
          </p>
